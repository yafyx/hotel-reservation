                            ...
                            <div x-show.transition.in="step === 1">
                                <div class="p-4">
                                    <div class="relative z-0 mb-6 w-full group">
                                        <input type="name" id="nama_tamu" name="nama_tamu"
                                    ...
                                    <div class="relative z-0 mb-6 w-full group">
                                        <input type="name" id="nama_pemesan" name="nama_pemesan"
                                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                            placeholder=" " required />
                                        <label
                                            class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama
                                    ...
                                    <div class="grid xl:grid-cols-3 xl:gap-6">
                                        ...
                                        <div class="relative z-0 mb-6 w-full group">
                                            ...
                                            <select id="tipe_kamar" name="tipe_kamar"
                                                ...
                                                //foreach option tipe_kamar in kamars table
                                ...
                                <div class="p-4">
                                    <div date-rangepicker class="flex items-center">
                                        <div class="relative">
                                            ...
                                            <input id="tgl_checkin" name="tgl_checkin" type="date"
                                        ...
                                        <div class="relative">
                                            ...
                                            <input id="tgl_checkout" name="tgl_checkout" type="date"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 datepicker-input"
